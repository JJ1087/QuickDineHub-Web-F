...
@Component({
  selector: 'app-restaurar-con-correo-repartidor',
  templateUrl: './restaurar-con-correo-repartidor.component.html',
  styleUrl: './restaurar-con-correo-repartidor.component.css'
})

export class RestaurarConCorreoRepartidorComponent {
