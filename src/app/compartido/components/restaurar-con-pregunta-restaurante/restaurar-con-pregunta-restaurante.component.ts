...
@Component({
  selector: 'app-restaurar-con-pregunta-restaurante',
  templateUrl: './restaurar-con-pregunta-restaurante.component.html',
  styleUrl: './restaurar-con-pregunta-restaurante.component.css'
})
export class RestaurarConPreguntaRestauranteComponent {
