...
@Component({
  selector: 'app-restaurar-con-pregunta',
  templateUrl: './restaurar-con-pregunta.component.html',
  styleUrl: './restaurar-con-pregunta.component.css'
})
export class RestaurarConPreguntaComponent {
